...
# Fill-in-the-blank prompts for data collection
...
def main():
    ...
    print(f"   Total prompts to run: {args.num_prompts or len(FILL_IN_THE_BLANK_PROMPTS)}")
    print("-" * 60)
    
    # Select prompts to run
    prompts_to_run = FILL_IN_THE_BLANK_PROMPTS[:args.num_prompts] if args.num_prompts else FILL_IN_THE_BLANK_PROMPTS
